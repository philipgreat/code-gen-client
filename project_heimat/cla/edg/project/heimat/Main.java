...
public class Main {
	...
	public static String INPUT_MODEL_FOLDER = "/works/jobs/heimat_v1/workspace/web-code-generator/sky";
	...
	public static String OUTPUT_JAVA_FOLDER = "/works/jobs/heimat_v1/workspace/heimat-biz-suite/bizcore/WEB-INF"; //
	// 生成的 page_flow 相关java源代码的(项目中)根目录, 通常指向 OUTPUT_JAVA_FOLDER 下的 xxx_custom_src. 因为项目迭代的关系,也可能需要额外指定目录
	public static String OUTPUT_PAGEFLOW_FOLDER_NAME = "heimat_client_src";
	// 生成目标项目的 项目名, 通常与模型文件的项目名一致
	public static String TARGET_PROJECT_NAME = "heimat";
	...
	public static String TARGET_PAGEFLOW_JAVA_PARENT_CLASS_FULL_NAME = "com.doublechaintech.heimat.wxappclient.WxappCustomService";
	...
	public static void main(String[] args) throws Exception {
		Map<String, String> envVars = Utils.put("base_package_name", Main.TARGET_BASE_PACKAGE_NAME)
                ...
                .put("resource_base_folder", "/works/jobs/heimat_v1/workspace/code-gen-client/project_heimat/resource")
