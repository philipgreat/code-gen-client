...
public class CodeGenTask {
	...
	protected String verifyNameOf(String name) {
		...
		if(componentPath ==  null){
			throw new IllegalArgumentException("Could not find the dest component path for: "+componentPath );
		}
	...
	protected String getSourceURI(String name){		
		...
		String fullPath = this.getURIPrefix()+componentPath+"?name="+this.getModel()+"&english="+context.forEnglish();
		return fullPath;
