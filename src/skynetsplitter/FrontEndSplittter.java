...
public class FrontEndSplittter {

    private static final int SECOND_IN_MS = 1000;

	public static void main(String[] args) throws Exception {
    	
    	String modelName = "frontendpoc";
...
//			run(new BigdataTask());
    ...
    private static String getProjectScriptOutputFolder(String projectFolder) {
		return String.format("/works/jobs/project_script/workspace/event-driven-generation/project_%s", projectFolder);
	}
