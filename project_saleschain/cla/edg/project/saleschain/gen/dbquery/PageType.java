...
public class PageType extends BaseModelBean {
  public String getFullClassName() {
    return "com.doublechaintech.saleschain.pagetype.PageType";
  }
  // 枚举对象
  public static EnumAttribute HOME =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "HOME")
          .chineseName("首页");
  public static EnumAttribute ME =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "ME").chineseName("我的");
  public static EnumAttribute GENERIC_PAGE =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "GENERIC_PAGE")
          .chineseName("Generic Page");
  public static EnumAttribute LISTOF_PAGE =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "LISTOF_PAGE")
          .chineseName("Listof Page");
  public static EnumAttribute SERVICE_CENTER =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "SERVICE_CENTER")
          .chineseName("功能大厅");
  public static EnumAttribute SIMPLE =
      new EnumAttribute("com.doublechaintech.saleschain.pagetype.PageType", "SIMPLE")
          .chineseName("普通");
