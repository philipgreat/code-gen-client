        ...
        return builder.change_request("add factory").zh_CN("添加工厂")
                .step("A").zh_CN("工厂信息")
                    .contains_event("factory basic info").zh_CN("工厂信息")
                        ...
                        .has_field("province").zh_CN("省")
                            .which_model_of(MODEL.province())
                            .values_can_select_from_query_by(null)
                            .place_holder("请选择所在省/直辖市")
                        .has_field("city").zh_CN("市")
                            .which_model_of(MODEL.city())
                            .values_can_select_from_query_by("${province}")
                            .place_holder("请选择所在城市")
