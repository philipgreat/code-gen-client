...
public class EventUpdateAdditionalSpec extends BaseModelBean {
  public String getFullClassName() {
    return "com.doublechaintech.xt20.eventupdateadditionalspec.EventUpdateAdditionalSpec";
  }
  // 枚举对象
  ...
  public StringAttribute additionalSpec() {
    StringAttribute member = new StringAttribute();
    member.setModelTypeName("string");
    // member.setName("additionalSpec");
    member.setName("additional_spec");
    useMember(member);
    return member;
  }
